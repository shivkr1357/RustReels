...
import clashpotbanner from "../assets/jackpotbanner.png";
...
const useStyles = makeStyles(theme => ({
  ...
  reward: {
    ...
    textAlign: "center",
    position: "relative",
    background: "linear-gradient(180deg,#191f26,#11161c)",
    borderRadius: "10px",
    transition: ".2s",
    WebkitUserSelect: "none",
    MozUserSelect: "none",
...
const Main = ({ isAuthenticated, isLoading, user }) => {
  ...
  useEffect(() => {
    ...
    // Listen for both new rain and rain updates
    chatSocket.on("new-rain", data => {
      setRainState({
        active: data.active,
        prize: data.prize,
    ...
    chatSocket.on("update-rain", data => {
      setRainState(prevState => ({
        ...prevState,
        prize: data.prize,
        players: data.players
      }));
    ...
    return () => {
      ...
      chatSocket.off("new-rain");
      chatSocket.off("update-rain");
    };
  }, [isAuthenticated]);
    ...
    <Box className={classes.root}>
      <Grow in timeout={430}>
        <Container className={classes.container}>
          ...
          <RainInfo handleClose={() => setOpenRainInfo(!openRainInfo)} open={openRainInfo} rainState={rainState} />
            ...
            {isLoading ? (<Box></Box>
              ...
              <Box className={classes.headerright}>
                <Box className={classes.headerbuttons}>
                  ...
                  >
                    <button className={classes.headerbuttonsDep}><span className={classes.headerbuttonsDepSpan}><span aria-label="Tray Plus icon" role="img" className="material-design-icon tray-plus-icon"><svg data-v-8351ef5e="" data-v-98afd824="" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" className="material-design-icon__svg"><path data-v-8351ef5e="" data-v-98afd824="" d="M2.31 33a8 8 0 010-8l9.88-17.115a8 8 0 016.929-4H38.88a8 8 0 016.928 4L55.691 25a8 8 0 010 8l-9.882 17.115a8 8 0 01-6.928 4H19.12a8 8 0 01-6.928-4L2.309 33z" fill="#5B6368"></path><path data-v-8351ef5e="" data-v-98afd824="" d="M31.762 35.339l-2.102 1.947L20.714 29l8.946-8.286 2.102 1.947L24.934 29l6.828 6.339z" fill="#fff"></path><path data-v-8351ef5e="" data-v-98afd824="" d="M23.476 27.62h13.81v2.761h-13.81v-2.762z" fill="#fff"></path></svg></span>Deposit</span></button>
                  </span>
                  <span
                    style={{ cursor: "pointer", }}
          ...
          {isLoading ? (
            ...
            <Box className={classes.games}>
              ...
              <Box className={classes.game}>
                <img alt="Coinflip" className={classes.gamesimages} src={clashpotbanner} />
              </Box>
              <Box className={classes.game}>
          ...
          <Box className={classes.rewards}>
            ...
            <a
              style={{ cursor: "pointer", textDecoration: "none", outline: "none", }}
              href="https://twitter.com/silorust"
              target="_blank"
