    ...
    if (completed) {
      ...
      return (
        <span style={{ display: "flex", }}>
          <span style={{ padding: "25px 23px 25px 23px", border: "1px solid #161b21", background: "rgb(27 33 41)", borderRadius: "20px", marginRight: "10px", }}>{days}<br /><span style={{ color: "rgb(104 107 114)", fontSize: "13px", }}>DAYS</span></span> <span style={{ padding: "25px 15px 25px 20px", border: "1px solid #161b21", background: "rgb(27 33 41)", borderRadius: "20px", marginRight: "10px", }}>{z(hours)}<br /><span style={{ color: "rgb(104 107 114)", fontSize: "13px", }}>HOURS</span></span> <span style={{ padding: "25px 30px 25px 30px", border: "1px solid #161b21", background: "rgb(27 33 41)", borderRadius: "20px", marginRight: "10px", }}>{z(minutes)}<br /><span style={{ color: "rgb(104 107 114)", fontSize: "13px", }}>MIN</span></span> <span className={classes.racetimer} style={{ padding: "25px 20px 25px 25px", border: "1px solid #161b21", background: "rgb(27 33 41)", borderRadius: "20px", }}>{z(seconds)}<br /><span style={{ color: "rgb(104 107 114)", fontSize: "13px", }}>SECS</span></span>
        </span>
      );
    } else {
      // Render a countdown
        ...
        <Grow in timeout={520}>
          <Container maxWidth="lg">
            <Box className={classes.profile}>
              <Box className={classes.prizebox} style={{ backgroundColor: activeRace ? "#1e252f" : "rgb(27 33 41)", padding: "35px 35px 15px 35px", border: activeRace ? "1px solid #161b21" : "1px solid rgb(27 33 41)", borderRadius: "20px", }}>
                <h1 style={{ color: "#fff" }}>
                  {loading ? (
                    <Skeleton
                      width={80}
              ...
              {loading ? (
                                ...
                                <Box display="flex" alignItems="center">
                                  <Box className={classes.avatar} style={{
                                    ...
                                    <Box className={classes.avatarimg}>
                                      <img className={classes.avatarimg2} id="avatar-img" alt="Avatar" src={entry.avatar} />
                                    </Box>
                                    <Box
                                  ...
                                  <Box className={classes.usernamebox}>
                                    <span style={{ marginLeft: "5px", }}>{entry.username}</span>
                                  </Box>
                                </Box>
                              </TableCell>
                              <TableCell>
                ...
                <Box className={classes.noRace}>
                  <h3 style={{ paddingTop: "87px", }}>NO CURRENTLY ACTIVE RACE!</h3>
                </Box>
              )}
            </Box>
          </Container>
