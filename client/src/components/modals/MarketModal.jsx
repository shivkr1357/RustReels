...
import USDT from "./withdraw/USDT";
import USDC from "./withdraw/USDC";
...
import solana from "../../assets/solanadepwith.png";
import usdt from "../../assets/usdtdepwith.png";
import usdc from "../../assets/usdcdepwith.png";
          ...
          <div>
            ...
            <div className={classes.ferzBz}>
              ...
              <div className={classes.bHNrGF} onClick={() => setCrypto("ltc")}>
                <div className={classes.iconHold}><img width="32px" height="32px" src={litecoin} alt="LTC" /></div>
                <div className={classes.info}><div className={classes.title}>Litecoin</div></div>
              </div>
              <div className={classes.bHNrGF} onClick={() => setCrypto("sol")}>
                <div className={classes.iconHold}><img width="32px" height="32px" src={solana} alt="SOL" /></div>
                <div className={classes.info}><div className={classes.title}>Solana</div></div>
              </div>
              <div className={classes.bHNrGF} onClick={() => setCrypto("usdt")}>
                <div className={classes.iconHold}><img width="32px" height="32px" src={usdt} alt="USDT" /></div>
                <div className={classes.info}><div className={classes.title}>USDT</div></div>
              </div>
              <div className={classes.bHNrGF} onClick={() => setCrypto("usdc")}>
                <div className={classes.iconHold}><img width="32px" height="32px" src={usdc} alt="USDC" /></div>
