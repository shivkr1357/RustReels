        ...
        <Box className={classes.flexbox}>
          <Box className={classes.inputs}>
            <Box className={classes.cryptocolor}>
              You will be credited after 3 confirmation. You might need to refresh the site once it is confirmed.
              <br />
              <br /><br />
            </Box>
            {loading ? (
              ...
              <Box className={classes.Depvalue}>
                <TextField
                  ...
                  variant="outlined"
                  value={cryptoData?.sol?.address}
                />
                <CopyToClipboard
                  text={cryptoData?.sol?.address}
