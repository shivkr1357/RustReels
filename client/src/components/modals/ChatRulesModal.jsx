  ...
  return (
    ...
    >
      ...
      <DialogContent dividers>
        ...
        <p><span className={classes.numbers}>5.</span> For fairness,please refer to the provably fair section.</p>
        <p><span className={classes.numbers}>6.</span> No spam.</p>
        <p><span className={classes.numbers}>7.</span> No links in chat. (exclduing battles)</p>
