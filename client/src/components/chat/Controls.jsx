    ...
    <Box>
      ...
      <Box className={classes.input}>
        ...
        <IconButton
          ...
          onClick={onClick}
          disableRipple
          style={{ background: "#096598", borderRadius: "5px", padding: "0px", filter: "drop-shadow(0 0 7px rgba(9, 101, 152,.4))", }}
        >
      ...
      <Box style={{ display: "flex", }}>
        <Box style={{ display: "flex", marginLeft: "10px", marginBottom: "10px", marginTop: "-5px", }}>
          <Button className={classes.reverse2}>
            <a style={{ outline: "none", }} href="https://x.com/silorust" target="_blank" rel="noreferrer" alt="Twitter">
          ...
          <Button className={classes.reverse2}>
            <a style={{ outline: "none", }} href="https://discord.gg/wFwmapsEDD" target="_blank" rel="noreferrer" alt="Discord">
          ...
          {/* <Button className={classes.reverse2}>
            <a style={{ outline: "none", }} href="https://steamcommunity.com/groups/" target="_blank" rel="noreferrer" alt="Steam">
          ...
          <Button className={classes.reverse3}>
            <a style={{ outline: "none", }} href="https://www.tiktok.com/@" target="_blank" rel="noreferrer" alt="TikTok">
            <svg style={{ color: "#5b6368", marginTop: "1px", }} xmlns="http://www.w3.org/2000/svg" fill="currentColor"  width="18" height="18" viewBox="0 0 448 512"><path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/></svg></a>
          </Button> */}
          <Button className={classes.reverse2}>
            <Tooltip
              interactive
              ...
              placement="top"
            >
              <a style={{ outline: "none", }} href="https://discord.gg/wFwmapsEDD" target="_blank" rel="noreferrer" alt="Support">
                <svg style={{ color: "#2c80af", marginTop: "-5px", }} data-v-17895ccb="" data-v-98afd824="" fill="currentColor" width="18" height="18" viewBox="0 0 24 24" className="material-design-icon__svg"><path d="M12,1C7,1 3,5 3,10V17A3,3 0 0,0 6,20H9V12H5V10A7,7 0 0,1 12,3A7,7 0 0,1 19,10V12H15V20H19V21H12V23H18A3,3 0 0,0 21,20V10C21,5 16.97,1 12,1Z"></path></svg>
              </a>
            </Tooltip>
          </Button>
          <ChatRulesModal
          ...
          <Button className={classes.reverse2} onClick={() => setChatModalVisible(state => !state)}>
            <Tooltip
              ...
              placement="top"
            >
              <svg style={{ color: "#2c80af", marginTop: "-5px", }} data-v-17895ccb="" data-v-98afd824="" fill="currentColor" width="18" height="18" viewBox="0 0 24 24" className="material-design-icon__svg"><path data-v-17895ccb="" data-v-98afd824="" d="M17,3H7A2,2 0 0,0 5,5V21L12,18L19,21V5C19,3.89 18.1,3 17,3Z"></path></svg>
            </Tooltip>
          </Button>
        </Box>
      </Box>
