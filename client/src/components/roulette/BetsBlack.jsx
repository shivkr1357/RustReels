...
const Bets = ({ players, redResult, greenResult, blackResult }) => {
  ...
  return (
    <Box className={classes.root}>
      <Box className={classes.betAmount} style={ blackBetsLength === 0 ? { borderRadius: "10px", borderBottom: "1px solid #0e0e0e", } : { borderBottom: "0px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", }}>
        <span style={{ color: "#e4e4e4", marginLeft: 0, }}>{blackBetsLength} Bets Total</span>
      ...
      <Box className={classes.bets} style={ blackBetsLength === 0 ? { borderTop: "0px", borderBottom: "0px", } : { borderTop: "1px solid #0e0e0e", paddingBottom: "8px", }}>
        <TransitionGroup>
